...
<div class="wrap d_wrap">
    ...
    <h2><?php echo $themename; ?>设置
        <span class="d_themedesc">发布来源：<a href="http://www.helshe.com/" target="_blank">码农宅</a> &nbsp;&nbsp; <a href="http://www.helshe.com" target="_blank">访问<?php echo $themename; ?>主页</a></span><span style="font-size:16px;color: rgb(245, 99, 99);padding-left:20px;">觉得主题不错？支持一下我继续更新吧 -><a href="http://yusi123.com/pay" target="_blank">捐赠</a></span>
    </h2>
...
<form method="post" class="d_formwrap">
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_sticky_b" name="d_sticky_b" <?php if (dopt('d_sticky_b')) {
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_thumbnail_b" name="d_thumbnail_b" <?php if (dopt('d_thumbnail_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
      列表Ajax加载分页内容
            <label class="checkbox inline">
                <input type="checkbox" id="d_ajaxpager_b" name="d_ajaxpager_b" <?php if (dopt('d_ajaxpager_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
		文章页顶部面包屑导航  <label class="checkbox inline">
                <input type="checkbox" id="d_singleMenu_b" name="d_singleMenu_b" <?php if (dopt('d_singleMenu_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
        </td>
 ...
 <tr>
      <td class="d_tit">热门排行</td>
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="hot_list_check" name="hot_list_check" <?php if (dopt('hot_list_check')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_post_views_b" name="d_post_views_b" <?php if (dopt('d_post_views_b')) {
        echo 'checked="checked"';
    } ?>>不显示访客数
            </label> &nbsp; &nbsp;
            <label class="checkbox inline">
                <input type="checkbox" id="d_post_author_b" name="d_post_author_b" <?php if (dopt('d_post_author_b')) {
        echo 'checked="checked"';
    } ?>>不显示作者
            </label> &nbsp; &nbsp;
            <label class="checkbox inline">
                <input type="checkbox" id="d_post_comment_b" name="d_post_comment_b" <?php if (dopt('d_post_comment_b')) {
        echo 'checked="checked"';
    } ?>>不显示评论数
            </label> &nbsp; &nbsp;
            <label class="checkbox inline">
                <input type="checkbox" id="d_post_time_b" name="d_post_time_b" <?php if (dopt('d_post_time_b')) {
        echo 'checked="checked"';
    } ?>>不显示时间
            </label> &nbsp; &nbsp;
  	<label class="checkbox inline">
                <input type="checkbox" id="d_post_like_b" name="d_post_like_b" <?php if (dopt('d_post_like_b')) {
        echo 'checked="checked"';
    } ?>>不显示喜欢
            </label>
        </td>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_jquerybom_b" name="d_jquerybom_b" <?php if (dopt('d_jquerybom_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_sign_b" name="d_sign_b" <?php if (dopt('d_sign_b')) {
        echo 'checked="checked"';
    } ?>>开启用户登录信息
            </label>
 	    <label class="checkbox inline">
                <input type="checkbox" id="d_bdshare_b" name="d_bdshare_b" <?php if (dopt('d_bdshare_b')) {
        echo 'checked="checked"';
    } ?>>开启百度分享
            </label>
        </td>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_tougao_b" name="d_tougao_b" <?php if (dopt('d_tougao_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_avatar_b" name="d_avatar_b" <?php if (dopt('d_avatar_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
            <label class="d_number">
                缓存
                <input class="d_num " name="d_avatarDate" id="d_avatarDate" type="number" value="<?php if (dopt('d_avatarDate')) {
 ...
 <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_spamComments_b" name="d_spamComments_b" <?php if (dopt('d_spamComments_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_sideroll_b" name="d_sideroll_b" <?php if (dopt('d_sideroll_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
            <label class="d_number">
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_pingback_b" name="d_pingback_b" <?php if (dopt('d_pingback_b')) {
        echo 'checked="checked"';
    } ?>>开启
                &nbsp; &nbsp;
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_autosave_b" name="d_autosave_b" <?php if (dopt('d_autosave_b')) {
        echo 'checked="checked"';
    } ?>>开启
                &nbsp; &nbsp;
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_tqq_b" name="d_tqq_b" <?php if (dopt('d_tqq_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_weibo_b" name="d_weibo_b" <?php if (dopt('d_weibo_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
   ...
   <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_weixin_b" name="d_weixin_b" <?php if (dopt('d_weixin_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
   ...
   <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_qqContact_b" name="d_qqContact_b" <?php if (dopt('d_qqContact_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
   ...
   <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_emailContact_b" name="d_emailContact_b" <?php if (dopt('d_emailContact_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
               <input type="checkbox" id="d_facebook_b" name="d_facebook_b" <?php if (dopt('d_facebook_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_twitter_b" name="d_twitter_b" <?php if (dopt('d_twitter_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_track_b" name="d_track_b" <?php if (dopt('d_track_b')) {
        echo 'checked="checked"';
    } ?>>开启
  <span class="d_tip">统计网站流量，推荐使用百度统计，国内比较优秀且速度快；还可使用Google统计、CNZZ等</span>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_headcode_b" name="d_headcode_b" <?php if (dopt('d_headcode_b')) {
        echo 'checked="checked"';
    } ?>>开启
<span class="d_tip">会自动出现在页面头部（head区域），可放置广告代码等自定义（css或js）的全局代码块</span>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_footcode_b" name="d_footcode_b" <?php if (dopt('d_footcode_b')) {
        echo 'checked="checked"';
    } ?>>开启
 <span class="d_tip">同上，但是在全站页面底部出现</span>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_adsite_01_b" name="d_adsite_01_b" <?php if (dopt('d_adsite_01_b')) {
        echo 'checked="checked"';
    } ?>>开启
 <span class="d_tip">广告区域，任意联盟广告和自定义广告的代码均可，下同</span>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_adindex_02_b" name="d_adindex_02_b" <?php if (dopt('d_adindex_02_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_adindex_01_b" name="d_adindex_01_b" <?php if (dopt('d_adindex_01_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_adindex_03_b" name="d_adindex_03_b" <?php if (dopt('d_adindex_03_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_adpost_01_b" name="d_adpost_01_b" <?php if (dopt('d_adpost_01_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_adpost_02_b" name="d_adpost_02_b" <?php if (dopt('d_adpost_02_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
    ...
    <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="d_adpost_03_b" name="d_adpost_03_b" <?php if (dopt('d_adpost_03_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
     ...
     <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="Mobiled_adindex_02_b" name="Mobiled_adindex_02_b" <?php if (dopt('Mobiled_adindex_02_b')) {
        echo 'checked="checked"';
 ...
 <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="Mobiled_adpost_01_b" name="Mobiled_adpost_01_b" <?php if (dopt('Mobiled_adpost_01_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
 ...
 <tr>
        ...
        <td>
            <label class="checkbox inline">
                <input type="checkbox" id="Mobiled_adpost_02_b" name="Mobiled_adpost_02_b" <?php if (dopt('Mobiled_adpost_02_b')) {
        echo 'checked="checked"';
    } ?>>开启
            </label>
